 ...
 * @author juliansoto
 */
public class VistaResUno extends javax.swing.JFrame {
    ...
    public VistaResUno() {
        ...
        modeloTabla.addColumn("CODIGO LIDER");
    ...
    private void initComponents() {
        ...
        setTitle("Respuesta Enunciado 1");
        setUndecorated(true);
        setResizable(false);
        ...
        jLabel1.setText("<html><center>Debido a que se generará una campaña de ascenso, se requiere conocer la información de los asesores (ID_Lider, Nombre, Primer_Apellido y Ciudad_Residencia) ordenado por Ciudad de residencia de manera ascendente.<center><html>");
        ...
        if (tblMiTabla.getColumnModel().getColumnCount() > 0) {
            ...
            tblMiTabla.getColumnModel().getColumn(2).setResizable(false);
        ...
        jLabel2.setFont(new java.awt.Font("Avenir", 1, 10)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(102, 102, 102));
        jLabel2.setText("Julian Soto. V1.0");
    ...
    public void genTabla() throws SQLException {
        ...
        for (int i = 0; i < respuesta.size(); i++) {
            ...
            datos[0] = respuesta.get(i).getIdLider() + "";
            datos[1] = respuesta.get(i).getNombre() + "";
            datos[2] = respuesta.get(i).getPrimerApellido() + "";
            datos[3] = respuesta.get(i).getCiudadResidencia() + "";
    ...
    private void btnRes1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRes1ActionPerformed
        try {
            ...
            Logger.getLogger(VistaResUno.class.getName()).log(Level.SEVERE, null, ex);
        }
