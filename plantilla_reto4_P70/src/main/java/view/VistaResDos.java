 ...
 * @author juliansoto
 */
public class VistaResDos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Respuesta Enunciado 2");
        setUndecorated(true);
        setResizable(false);
        ...
        jLabel1.setText("<html><center>Se requiere listar las compras por proyecto (Id_Compra, Proveedor, Constructora, Banco_Vinculado, y Ciudad) ubicados en la ciudad de Salento y que el proveedor sea Homecenter.<center><html>");
    ...
    public void genTabla() throws SQLException {
        ...
        for (int i = 0; i < respuesta.size(); i++) {
            ...
            datos[0] = respuesta.get(i).getIdCompra()+ "";
            datos[1] = respuesta.get(i).getProveedor()+ "";
            datos[2] = respuesta.get(i).getConstructora()+ "";
            datos[3] = respuesta.get(i).getBancoVinculado()+ "";
            datos[4] = respuesta.get(i).getCiudad() + "";
    ...
    private void btnRes1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRes1ActionPerformed
        try {
            ...
            Logger.getLogger(VistaResDos.class.getName()).log(Level.SEVERE, null, ex);
        }
